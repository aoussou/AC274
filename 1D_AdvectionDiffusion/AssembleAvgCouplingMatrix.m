function Cavg = AssembleAvgCouplingMatrix
...
Cavg = spalloc(n_total_dofs, n_total_dofs, ...
    ...
    for face_id=1:2
        ...
        if neighbor_id == -1
            ...
            if normal_e * advection_velocity > 0
                ...
                % not "averaging" here
                Cavg(dofs_e,dofs_e) = ...
                    Cavg(dofs_e,dofs_e) + 2*AvgCouplingMatrix_ee;
                %inflow BC
            ...
            Cavg(dofs_e,dofs_e) = Cavg(dofs_e,dofs_e) + ...
                AvgCouplingMatrix_ee;
            Cavg(dofs_e,dofs_n) = Cavg(dofs_e,dofs_n) + ...
                AvgCouplingMatrix_en;
            Cavg(dofs_n,dofs_n) = Cavg(dofs_n,dofs_n) + ...
                AvgCouplingMatrix_nn;
            Cavg(dofs_n,dofs_e) = Cavg(dofs_n,dofs_e) + ...
